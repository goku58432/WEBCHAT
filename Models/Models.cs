...
namespace ChatAPI.Models
{
    public class Usuario
    {
        ...
        public string AvatarColor { get; set; } = "#e63946";using System.ComponentModel.DataAnnotations;
namespace ChatAPI.Models
{
    public class Usuario
    {
        ...
        // Guarda el vector de características del rostro como JSON (array de floats)
